...
export const sendWhatsAppNotification = async (
  ...
  switch (data.type) {
    ...
    case 'brochure':
      message = `*New Brochure Download*%0A%0A*Name:* ${data.name}%0A*Email:* ${data.email}%0A*Phone:* ${data.phone || 'N/A'}%0A*Property:* ${data.interest || 'Property'}`;
      break;
  }
